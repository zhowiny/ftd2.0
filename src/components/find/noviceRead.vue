<template>
  <div class="titleHeight noviceRead">
    <div :class='{active:status[0]}'>
      <h3 @click="toggle(0)">1.如何成为富通贷用户?</h3>
      <div class="question">
    ...
    <div :class='{active:status[4]}'>
      <h3 @click="toggle(4)">5.用户在注册、实名认证、提现时收不到验证码怎么办？</h3>
      <div class="question">
